...
/*
  ...
  - Package in java can be categorized in two form
    - built-in package {lang , awt, java x, swing, net, io, util, sequel}
    ...
    import java.util.vector; // import the vector class from until package
    import java.util.*;// import all the classes from until packages
